...
export const Footer = () => {
  ...
  return <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
        ...
        <div className="">
          ...
          {company.map((media, i) => {
            return <p key={i} className="mb-4">
              <Link href={media.url} className="text-gray-600">{media.name}</Link>
            </p>
          })}
        </div>
        <div className="">
    ...
    <div className="text-center p-6 bg-gray-200">
      ...
      <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> Stryder91</a>
    </div>
  </footer>
}